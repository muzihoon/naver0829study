...
public class Ex15_ListStudent2 {

	List<Student> list=new ArrayList<Student>();
	Scanner sc= new Scanner(System.in);

	public Ex15_ListStudent2() {
		// TODO Auto-generated constructor stub
		list.add(new Student("카리나", 100,"o"));
		list.add(new Student("다니엘", 90,"ab"));
	...
	public static void main(String[] args) {
		...
		Ex15_ListStudent2 ex=new Ex15_ListStudent2();
