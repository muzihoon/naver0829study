...
public class Ex2_KeyInput {
	...
	public static void main(String[] args) {
		...
		//if문으로 해도 가능, 조건(삼항) 연산자 (조건식 ? 참일때 값 : 거짓일때의 값) 로 해도 된다.1
//		String msg=age>20?"성인":"미성년자";
		
		//if문으로 할 경우
		String msg="";
		//지역변수는 자동초기화가 안되고 쓰레기값이 들어있으므로
		//값이 안들어 갈 경우를 대비해서 초기값을 지정하는 것이 좋다.
		//지역 변수는 그 구역을 빠져나가게 되면 자동소멸 되므로 사용이 불가능해진다.
		if(age>=20) {
			//한문장만 쓸 경우 {} 구역설정 생략가능, 두문장 이상일 경우 반드시 구역설정({})
			msg="성인";
		}else {
