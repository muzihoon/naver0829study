...
public class Ex7_Format {
	...
	public static void main(String[] args) {
		...
		//패턴 1
		SimpleDateFormat dateFormat1=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss EEE");//MM:월 mm:분EEE:요일 짧게 HH:24시간 기준
		...
		numberFormat1.setMaximumFractionDigits(1);//소수점 한자리로 출력. 반올림 되어서 나온다.
		System.out.println(numberFormat1.format(num));
	}
