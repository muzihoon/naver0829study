...
<%
    ...
    list.add(new ShopDto("머리끈","20",8000,"yellow"));
    list.add(new ShopDto("보석머리띠","7",15000,"purple"));
    list.add(new ShopDto("뿌띠스카프","11",59000,"magenta"));
    list.add(new ShopDto("화이트자켓","18",23000,"white"));
%>
<table class="table table-bordered" style="width: 500px;">
    ...
    <tr>
        ...
        <td> <%=dto.getPrice() %> </td>
        <td align="center">
            <img src="../image/<%=dto.getPhoto()%>.jpg" alt="" class="photo">
        </td>
        <td align="center">
